<?php
/**
 * Template Name: Venus Awards - Regional Home Page
 */
?>
<?php get_header(); ?>

<?php get_template_part( 'sections/featured-image-area' ); ?>
...
<div id="content" class="container site-content">
    ...
    <div class="main-box">
        <?php while ( have_posts() ) : the_post(); ?>
            ...
            <?php get_template_part( 'sections/venusawards/content-page', get_post_format()); ?>
